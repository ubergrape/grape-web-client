...
describe('objects: Search', () => {
  ...
  describe('Search#toString', () => {
    it('should return correct md', () => {
      expect(object.toString()).to.be('[%5b>"Plans/Discussions"%5d](cg://googledrive|file|8b37ec07b198be90e8086e1065821492|%28https://docs.google.com/a/ubergrape.com%28/folderview?id=0B_TCKOxiyU4wNTBkNWZiNzAtZTVjZS00ZGUzLWI2ZjItZTNmMThmZjhjMDZj&usp=drivesdk%29||)')
    })
  })
})
