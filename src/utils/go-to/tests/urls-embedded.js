...
describe.only('goTo with url in embedded mode', () => {
  ...
  it('should call onExternal callback if URL has no messageId and channel is not current', () => {
    const {map, called, args} = callbacks()
    goTo('https://grape.io/chat/channel/6009', {
      currChannel: 2000,
      serviceUrl: 'https://grape.io',
  ...
  it('should call onExternal callback if URL contains messageId and channel is not current', () => {
    const {map, called, args} = callbacks()
    goTo('https://grape.io/chat/channel/6009:3d062f7810d411e8aa120242ac1d0003', {
      currChannel: 2000,
      serviceUrl: 'https://grape.io',
    ...
    expect({called, args}).to.eql({
      called: {onExternal: 1, onRedirect: 0, onSilentChange: 0, onUpdateRouter: 0},
      args: ['https://grape.io/chat/channel/6009:3d062f7810d411e8aa120242ac1d0003', 'grape']
    })
  })
  ...
  it('should call onSilentChange callback if URL leads to logout page', () => {
    const {map, called, args} = callbacks()
