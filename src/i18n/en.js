...
export default {
  ...
  noRoomFound:
    'We could not find what you were looking for - the room might have been deleted, renamed or moved.',
  ...
  dropFileToUploadMaxFileSize:
    'We support almost every file type up to a size of {limit}mb.',
  ...
  disabledMessagePlaceholder:
    'This user has been deleted. Messaging is disabled.',
  keyESC: 'ESC',
  ...
  usersAreTyping:
    '{users} and {othersAmount} {othersAmount, plural, one {other} other {others}} are typing',
  ...
  messageNotSendCheckConnection:
    "The message couldn't be sent. Check your internet connection and",
  clickToTryAgain: 'click to try again',
  roomIsPublic:
    'This group is public. Every member can join and read the history.',
  roomIsPrivate:
    'This group is private. Only invited members can see and join this group.',
  ...
  pmIntro:
    'This is a private conversation between you and {partner}.{br}Private conversations are only accessible to the two of you.',
  ...
  enter: 'Enter',
  justInvited:
    'Congratulations! You just invited {user} {amount, plural, =0 {} one {and one more people} other {and {amount} more people}}.',
  ...
  introTextWelcome:
    "Grape is a chat application for teams. We help you to make your team communication more efficient, productive and fun. If you haven't used Grape already, we recommend you to take our 90 seconds tutorial.",
  introHlSearchBrowser: 'Find your team data',
  introTextSearchBrowser:
    'Search appointments, files and more from service integrations (like Google Apps or Exchange) or browse the web (e.g. GIFs). To open Grape Search click the button or press #',
  introHlManageGroups: 'Manage groups',
  introTextGroups:
    'Chat groups can be public or private and can be based on projects, topics (e.g. daily lunch) or your departments (e.g. marketing).',
  introHlPm: 'Communicate 1-to-1',
  introTextPm:
    'Start quickly private conversations with your colleagues - even if they haven’t joined Grape yet.',
  introHlSearch: 'Stay productive',
  introTextSearch:
    'Search conversations, browse your mentions or view shared files - these handy helpers make your life a lot easier.',
  addTeamMembersLinkIntro: 'add your team members',
  connectServicesLinkIntro: 'connect your services',
  introHlDone: 'Well done!',
  introTextDone:
    "Don't forget to {addTeamMembersLink} and to {connectServicesLink}. If you have any question, do not hesitate to write us by clicking the question mark on the top right corner.",
  ...
  notificationSettingsHint:
    "You can change the default preferences in your account's {link}",
  ...
  logOut: 'Log out',
  settings: 'Settings',
  roomDeleteDialogInputLabel: 'Please type in the name of the room to confirm',
  roomDeleteDialogDelete: 'delete',
  roomDeleteDialogConfirmMessage: 'Are you sure you want to delete this room?',
  ...
  roomDeleteDialogProvideName:
    'Please enter the name of the room you want to delete.',
  roomDeleteDialogNotMatchingName: "Room name doesn't match",
  roomDeleteDialoginputPlaceholder: 'Confirm room name...',
  ...
  labeledMessagesNoContentText1:
    'Grape automatically summarizes your conversations, so you can browse and find them based on context - we call it “amplified intelligence”.',
  labeledMessagesNoContentText2:
    'Write a few Tasks or Questions to see them appear here!',
  newImportantMessages:
    '{amount} {amount, plural, one {new important message} other {new important messages}}',
  trainingModeHintWithLink:
    'IA: This system is in training mode ({learnMoreLink})',
  learnMoreLink: 'learn more',
  noMessagesFound: 'No messages found',
  emptyPinnedMessagesSidebarHeadline: 'No messages have been pinned yet!',
  emptyPinnedMessagesSidebarDescription:
    'Choose "Pin message" in the context menu of any message to make it show up here.',
