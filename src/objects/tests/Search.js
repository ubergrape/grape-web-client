...
describe('objects: Search', () => {
  ...
  describe('Search#toString', () => {
    it('should return correct md', () => {
      expect(object.toString()).to.be('[#>"Plans/Discussions"](cg://googledrive|file|#>"Plans/Discussions"|%28https://docs.google.com/a/ubergrape.com%28/folderview?id=0B_TCKOxiyU4wNTBkNWZiNzAtZTVjZS00ZGUzLWI2ZjItZTNmMThmZjhjMDZj&usp=drivesdk%29||)')
    })
  })
})
