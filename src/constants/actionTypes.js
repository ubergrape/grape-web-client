...
export const SET_NEW_CONVERSATION_TAB = 'SET_NEW_CONVERSATION_TAB'
export const SET_TAB_LOADING_STATE = 'SET_TAB_LOADING_STATE'
export const CHANGE_GROUPS_QUERY = 'CHANGE_GROUPS_QUERY'
export const REQUEST_GROUPS_SEARCH = 'REQUEST_GROUPS_SEARCH'
export const HANDLE_GROUPS_SEARCH = 'HANDLE_GROUPS_SEARCH'
export const REQUEST_MEMBERSHIP_GROUPS_LOADING =
  'REQUEST_MEMBERSHIP_GROUPS_LOADING'
export const HANDLE_NO_GROUPS_LEFT_TO_JOIN = 'HANDLE_NO_GROUPS_LEFT_TO_JOIN'
export const HANDLE_NO_OTHER_GROUPS_IN_ORG = 'HANDLE_NO_OTHER_GROUPS_IN_ORG'
export const CHANGE_PEOPLE_QUERY = 'CHANGE_PEOPLE_QUERY'
export const REQUEST_PEOPLE_SEARCH = 'REQUEST_PEOPLE_SEARCH'
export const HANDLE_PEOPLE_SEARCH = 'HANDLE_PEOPLE_SEARCH'
export const REQUEST_MEMBERSHIP_PEOPLE_LOADING =
  'REQUEST_MEMBERSHIP_PEOPLE_LOADING'
export const HANDLE_NO_PEOPLE_LEFT_TO_JOIN = 'HANDLE_NO_PEOPLE_LEFT_TO_JOIN'
export const HANDLE_NO_OTHER_PEOPLE_IN_ORG = 'HANDLE_NO_OTHER_PEOPLE_IN_ORG'

export const SHOW_CREATE_ROOM = 'SHOW_CREATE_ROOM'
export const HIDE_CREATE_ROOM = 'HIDE_CREATE_ROOM'
export const SET_IS_PRIVATE = 'SET_IS_PRIVATE'
export const HANDLE_GROUP_NAME_CHANGE = 'HANDLE_GROUP_NAME_CHANGE'
export const HANDLE_GROUP_DESCRIPTION_CHANGE = 'HANDLE_GROUP_DESCRIPTION_CHANGE'
export const CHANGE_MEMBERS_QUERY = 'CHANGE_MEMBERS_QUERY'
export const REQUEST_MEMBERS_SEARCH = 'REQUEST_MEMBERS_SEARCH'
export const HANDLE_MEMBERS_SEARCH = 'HANDLE_MEMBERS_SEARCH'
export const HANDLE_MEMBER_SELECT = 'HANDLE_MEMBER_SELECT'
export const HANDLE_MEMBER_REMOVE = 'HANDLE_MEMBER_REMOVE'
export const REQUEST_CREATE_ROOM = 'REQUEST_CREATE_ROOM'
export const HANDLE_TAGS_INPUT_INTERACTION = 'HANDLE_TAGS_INPUT_INTERACTION'
export const HANDLE_CURRENT_SELECTED_MEMBER = 'HANDLE_CURRENT_SELECTED_MEMBER'
export const HANDLE_CREATE_ROOM_ERROR_DETAILS =
  'HANDLE_CREATE_ROOM_ERROR_DETAILS'
