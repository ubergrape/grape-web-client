...
export const HANDLE_INVITE_TO_ORG_SUCCESS = 'HANDLE_INVITE_TO_ORG_SUCCESS'
export const CLEAR_INVITE_TO_ORG_ERROR = 'CLEAR_INVITE_TO_ORG_ERROR'
export const HIDE_JUST_INVITED_TO_ORG = 'HIDE_JUST_INVITED_TO_ORG'
...
export const REQUEST_ADD_NOTIFICATION_STACK = 'REQUEST_ADD_NOTIFICATION_STACK'
export const REQUEST_REMOVE_NOTIFICATION_STACK = 'REQUEST_REMOVE_NOTIFICATION_STACK'
