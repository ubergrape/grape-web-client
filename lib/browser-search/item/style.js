...
var rules = {
  ...
  name: {
    extend: [_grapeThemeDistFonts2['default'].normal, _grapeJssUtils2['default'].ellipsis],
    lineHeight: 1.2
  },
  info: {
    extend: [_grapeThemeDistFonts2['default'].small, _grapeJssUtils2['default'].ellipsis],
    marginTop: 4,
    opacity: 0.5
  },
  metaContainer: {
