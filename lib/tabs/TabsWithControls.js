...
var TabsWithControls = (function (_Component) {
  ...
  TabsWithControls.prototype.getInnerWidth = function getInnerWidth() {
    ...
    return _reactDom2['default'].findDOMNode(inner).offsetWidth;
  };
  ...
  TabsWithControls.prototype.getViewportNode = function getViewportNode() {
    return _reactDom2['default'].findDOMNode(this.tabs);
  };
  ...
  TabsWithControls = _grapeWebLibJss.useSheet(_tabsWithControlsStyle2['default'])(TabsWithControls) || TabsWithControls;
