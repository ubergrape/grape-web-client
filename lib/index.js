...
/**
 * FIXME: when rewriting the ActiveRecord-style adapter to a EntityManager-style
 * pattern, it would be good to expose the models early as separate classes, and
 * have one "App" kind of class that ties everything together with server
