...
var _searchBrowserModalBrowser = require('./search-browser/ModalBrowser');

var _searchBrowserModalBrowser2 = _interopRequireDefault(_searchBrowserModalBrowser);
...
exports.SearchModalBrowser = _searchBrowserModalBrowser2['default'];
...
if (document.registerReact) {
  ...
  document.registerReact('grape-search-modal-browser', _searchBrowserModalBrowser2['default']);
