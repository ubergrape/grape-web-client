...
App.prototype._tryAddRoom = function App__tryAddRoom(room) {
	...
	if (room.type === 'room')
		return this.organization.rooms.push(room);
...
App.prototype.autocomplete = function(text, organizationId, callback) {
	this.wamp.call(PREFIX + 'search/autocomplete', text, organizationId, 
			function (err, result) {
