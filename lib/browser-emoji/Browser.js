...
var Browser = (function (_Component) {
  ...
  Browser.prototype.createState = function createState(props) {
    ...
    var newEmojiSheet = _lodashObjectGet2['default'](props, 'images.emojiSheet');
    ...
    var isFirstRender = state.isFirstRender == null ? true : false;
  ...
  Browser.prototype.selectTab = function selectTab(selector) {
    ...
    var sections = dataUtils.getSections(facet, this.props.search);
    this.setState({ tabs: tabs, sections: sections, facet: facet });
  };
...
var PublicBrowser = _reactJss2['default'](Browser, _browserStyle2['default']);
...
PublicBrowser.Icon = _Icon2['default'];
