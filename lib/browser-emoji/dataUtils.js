...
var _metaJson = require('./meta.json');

var _metaJson2 = _interopRequireDefault(_metaJson);
...
var META_MAP = _lodashCollectionIndexBy2['default'](_metaJson2['default'], 'name');

sections.emoji = (function () {
  var staticSections = [];

  _metaJson2['default'].forEach(function (data) {
...
function getTabs(options) {
  ...
  if (stats.emoji) {
    ...
    tabs.push({
      ...
      icon: _react2['default'].createElement(_Icon2['default'], { style: style })
    });
  }
