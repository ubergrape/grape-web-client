...
var HighlightedTextarea = (function (_Component) {
  ...
  _createClass(HighlightedTextarea, null, [{
    ...
    value: {
      ...
      browser: _react.PropTypes.string,
  ...
  HighlightedTextarea.prototype.onChange = function onChange(e) {
    ...
    this.setState({
      text: value,
      textWithObjects: _utils.getTextAndObjects(this.state.objects, value),
      caretPos: selectionEnd,
      objectsPositions: _utils.getObjectsPositions(this.state.objects, value)
    });
  ...
  HighlightedTextarea.prototype.addQueryString = function addQueryString(str) {
    var textarea = this.refs.textarea;
  ...
  HighlightedTextarea.prototype.submit = function submit(e) {
    ...
    if (e.metaKey || e.shiftKey || !this.state.text.trim() || this.props.browser) return false;
