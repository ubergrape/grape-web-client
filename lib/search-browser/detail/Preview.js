...
var Preview = (function (_Component) {
  ...
  Preview.prototype.render = function render() {
    ...
    if (this.state.loading && !error) {
      return _react2['default'].createElement(_grapeWebLibSpinnerSpinner2['default'], { image: this.props.spinner, active: true });
    }
  ...
  Preview = _grapeWebLibJss.useSheet(_previewStyle2['default'])(Preview) || Preview;
  return Preview;
})(_react.Component);
