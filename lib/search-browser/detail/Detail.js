...
var Detail = (function (_Component) {
  ...
  Detail.prototype.renderMain = function renderMain() {
    ...
    return _react2['default'].createElement(
      ...
      iconUrl && _react2['default'].createElement('img', { src: iconUrl, className: classes.icon }),
  ...
  Detail.prototype.render = function render() {
    ...
    if (_lodashLangIsEmpty2['default'](data)) return _react2['default'].createElement(_DetailEmpty2['default'], { images: images });
    ...
    return _react2['default'].createElement(
      ...
      previewUrl && _react2['default'].createElement(_Preview2['default'], { image: previewUrl, spinner: images.spinner }),
      this.renderMain(),
      this.renderMeta()
    );
  };
