...
var Detail = (function (_Component) {
  ...
  Detail.prototype.renderHeader = function renderHeader() {
  ...
  Detail.prototype.renderEmpty = function renderEmpty() {
    var classes = this.props.sheet.classes;
  ...
  Detail.prototype.render = function render() {
    ...
    if (_lodashLangIsEmpty2['default'](data)) return this.renderEmpty();
