...
var Default = (function (_Component) {
  ...
  Default.prototype.render = function render() {
    ...
    var focusedItem = this.props.focusedItem;

    var sidebarContent = undefined;

    if (focusedItem.type === 'filters') {
      sidebarContent = _react2['default'].createElement(_Info2['default'], this.props);
    } else {
      sidebarContent = _react2['default'].createElement(_detailDetail2['default'], _extends({}, this.props, { data: focusedItem.detail }));
    }
    ...
    return _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        ...
        _react2['default'].createElement(_gridGrid2['default'], _extends({}, this.props, { className: classes.leftColumn })),
        _react2['default'].createElement(
  ...
  Default = _grapeWebLibJss.useSheet(_browserStyle2['default'])(Default) || Default;
  return Default;
})(_react.Component);
