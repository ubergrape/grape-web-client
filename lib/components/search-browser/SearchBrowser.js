...
var Browser = (function (_Component) {
  ...
  Browser.prototype.onSelectAction = function onSelectAction(action) {
  ...
  Browser.prototype.onInput = function onInput(query) {
    ...
    var callback = _props.inputSearchBrowserSearch;
    var delay = _props.externalServicesInputDelay;
    var isExternal = _props.isExternal;
  ...
  Browser.prototype.onBlur = function onBlur(e) {
  ...
  _createClass(Browser, null, [{
    ...
    value: {
      ...
      inputSearchBrowserSearch: _react.PropTypes.func,
      ...
      focusedList: _react.PropTypes.oneOf(['objects', 'actions'])
    },
    enumerable: true
  }]);
