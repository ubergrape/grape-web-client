...
var _lodashUtilityTimes = require('lodash/utility/times');
...
describe('grape-input:', function () {
  ...
  describe('GrapeInput() with search', function () {
    it('should open search browser', function () {
      var input = _react2['default'].createElement(_GrapeInput2['default'], { browser: 'search', data: _mocksData0Json2['default'], focused: true, setTrigger: true });
      _test.render(input);
  ...
  describe('GrapeInput() insert object', function () {
    function insert(onInsertItem, onDidMount) {
      ...
      _lodashUtilityTimes2['default'](2, function () {
