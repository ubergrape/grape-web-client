...
var Grid = (function (_Component) {
  ...
  Grid.prototype.onInvisible = function onInvisible(item, visibilityRect) {
    ...
    var viewPortNode = _reactDom2['default'].findDOMNode(this);
    var itemNode = _reactDom2['default'].findDOMNode(item);
  ...
  Grid.prototype.render = function render() {
    ...
    return _react2['default'].createElement(
      ...
      this.props.data.map(function (data) {
        return _react2['default'].createElement(_Section2['default'], _extends({}, data, _lodashObjectPick2['default'](_this.props, 'onSelect', 'Item', 'focused'), _this.props.section, {
  ...
  var _Grid = Grid;
  Grid = _grapeWebLibJss.useSheet(_gridStyle2['default'])(Grid) || Grid;
  return Grid;
})(_react.Component);
