...
var Editable = (function (_Component) {
  ...
  _createClass(Editable, null, [{
    ...
    value: {
      ...
      onEditPrevious: _lodashUtilityNoop2['default'],
      onSubmit: _lodashUtilityNoop2['default'],
  ...
  Editable.prototype.shouldComponentUpdate = function shouldComponentUpdate() {
  ...
  Editable.prototype.render = function render() {
    return _react2['default'].createElement(
      _globalEventGlobalEvent2['default'],
      {
        event: 'resize',
  ...
  Editable.prototype.applyProps = function applyProps(props) {
  ...
  Editable.prototype.setClassName = function setClassName(props) {
    var classes = props.sheet.classes;

    var classNames = [classes.editable];
  ...
  Editable.prototype.setContentEditable = function setContentEditable(props) {
    var action = props.disabled ? 'remove' : 'set';
  ...
  Editable.prototype.setFocus = function setFocus(props) {
    if (!props.focused || !this.caret.focus()) return;
    this.caret.selectMarkers();
  };

  Editable.prototype.setPlaceholder = function setPlaceholder(props) {
  ...
  Editable.prototype.getTextContent = function getTextContent(options) {
  ...
  Editable.prototype.setTextContent = function setTextContent(text) {
    ...
    this.scribe.transactionManager.run(function () {
      ...
      _this3.caret.move();
      _this3.onResize();
      if (!options.silent) _this3.onChange(options);
    });
    return true;
  };
  ...
  Editable.prototype.submit = function submit(e) {
    ...
    var objectsOnly = !this.getTextContent({ skipObjects: true }).trim().length;
  ...
  Editable.prototype.ensureNewLine = function ensureNewLine(key, e) {
    ...
    this.scribe.transactionManager.run(function () {
      var selection = _this6.caret.createSelection(true);
      _this6.caret.placeMarker(selection);
  ...
  Editable.prototype.onKeyDownDebounced = function onKeyDownDebounced() {
    ...
    if (utils.isFocused(this.node)) this.handleKeyDown.apply(this, arguments);
  };
  ...
  Editable.prototype.onResize = function onResize() {
  ...
  Editable.prototype.onBlur = function onBlur() {
    this.props.onBlur();
  };

  Editable.prototype.onFocus = function onFocus() {
    this.props.onFocus();
  };

  var _Editable = Editable;
  Editable = _grapeWebLibJss.useSheet(_style2['default'])(Editable) || Editable;
  return Editable;
})(_react.Component);
