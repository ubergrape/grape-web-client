...
var Input = (function (_Component) {
  ...
  Input.prototype.closeBrowser = function closeBrowser(state) {
  ...
  Input.prototype.onChangeQuery = function onChangeQuery(newQueryStr) {
    ...
    this.replaceQuery(newQueryStr, options, function (replaced) {
      ...
      return replaced ? open(replaced) : _this6.insertQuery(newQueryStr, options, open);
    });
  };
  ...
  Input.prototype.onResize = function onResize() {
    this.emit('resize');
  };
