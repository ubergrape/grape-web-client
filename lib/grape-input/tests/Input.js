...
describe('input', function () {
  describe('Input()', function () {
    it('should render without props', function () {
      render(_reactAddons2['default'].createElement(_2['default'], null), document.body);
      _expectJs2['default'](_test.$('input')).to.be.an(Element);
    });
  });

  describe('Input() with search', function () {
    it('should open search browser', function () {
      var input = _reactAddons2['default'].createElement(_2['default'], { type: 'search', data: _mocksData0Json2['default'], focused: true });
      render(input, document.body);
      var completeWrapper = _test.$('input complete-wrapper');
  ...
  describe('Input() auto close', function () {
    function create(onDidMount, onRender) {
      ...
      var input = _reactAddons2['default'].createElement(_2['default'], {
        type: 'search',
        data: data,
        focused: true,
    ...
    it('shound render "nothing found"', function (done) {
      create(function () {
        _expectJs2['default'](_test.$('empty', 'input')).to.be.an(Element);
        done();
      });
    });
  ...
  describe('Input() insert object', function () {
    function insert(onInsertItem, onDidMount) {
      ...
      data.search.queries = [];
      var input = _reactAddons2['default'].createElement(_2['default'], { type: 'search', data: data, focused: true, onInsertItem: onInsertItem, onDidMount: onDidMount });
      render(input, document.body);
      Simulate.keyDown(_test.$('editable'), { keyCode: 13 });
    }
