...
exports.hoverSearchBrowserAction = hoverSearchBrowserAction;
...
function selectTab(selector, state) {
  ...
  var tabIndex = findIndexBySelector(selector, tabs, function (tab) {
    return tab.selected;
  });
...
function focusSearchBrowserAction(focusedAction) {
  return {
...
function hoverSearchBrowserAction(hoveredAction) {
  return {
